...
Pour chaque i\up{ème) lignes ou colonnes on va devoir parcourir chaque j\up{ème) des colonnes ou des lignes correspondantes. Car toutes les cases du tableau seront vérifiées même si la case est vide qui correspond à une valeur est nulle. Le programme aura donc une complexité temporelle de $O(n^2)$ pour cet algorithme de parcours.